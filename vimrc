...
set noshowmode " Hide the default mode text (e.g. -- INSERT -- below the status
...
Bundle 'git@github.com:jaxbot/github-issues.vim.git'
...
Bundle 'https://github.com/vim-scripts/star-search.git'
"Bundle 'https://github.com/editorconfig/editorconfig-vim.git'
Bundle 'https://github.com/TFenby/python-mode.git'
...
nmap <C-\>f :cscope find g <C-R>=expand("<cword>")<CR><CR>
...
nmap <C-\>d :cscope find d <C-R>=expand("<cword>")<CR><CR>
 ...
 "" powerline相关设置
 "--------------------------------------------------------------------------------
set guifont=PowerlineSymbols\ for\ Powerline    " set fonts for gui vim
